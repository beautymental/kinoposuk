...
use App\Controllers\CategoryFilmsController;
...
use App\Controllers\Admin\RegisterController as AdminRegisterController;
...
return [
    ...
    Route::get('/categories/films', [CategoryFilmsController::class, 'index']),
];
