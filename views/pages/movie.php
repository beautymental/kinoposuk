                    ...
                    <div class="col-md-4">
                        ...
                        <?php } else { ?>
                            <div class="alert alert-warning m-3 w-100">
                                Для того, щоб залишити відгук , необхідно <a href="/login">бути авторизованим</a>
                            </div>
                        <?php } ?>
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text">Оцінка <span class="badge bg-warning warn__badge"><?php echo $movie->avgRating() ?></span></p>
                            <p class="card-text"><?php echo $movie->description() ?></p>
                            <p class="card-text"><small class="text-body-secondary">Доданий <?php echo $movie->createdAt() ?></small></p>
                            <h4>Відгуки</h4>
