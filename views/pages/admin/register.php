...
<?php $view->component('start'); ?>
    <main>
        ...
        <div class="container d-flex justify-content-center">
            <form action="/admin/register" method="post" class="d-flex flex-column justify-content-center w-50 gap-2 mt-5 mb-5">
                <div class="row g-2">
                    <div class="col-md">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md">
                        <div class="form-floating">
                            ...
                            <label for="password_confirmation">Підтверження</label>
                        </div>
                    </div>
                </div>
                <div class="row g-2">
                    <button class="btn btn-primary">Cтворити акаунт</button>
                </div>
            </form>
        </div>
    </main>
