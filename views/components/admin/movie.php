...
<tr>
    ...
    <td><span class="badge bg-warning warn__badge"> <?= isset($rating[$movie->id()]) ? $rating[$movie->id()] : '-' ?></span></td>
    <td>
        <div class="dropdown d-flex justify-content-end">
            <a class="btn btn-secondary dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Дія</a>
